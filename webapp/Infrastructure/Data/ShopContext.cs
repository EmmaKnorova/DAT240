...
public class ShopContext(DbContextOptions configuration, IMediator mediator) : DbContext(configuration)
{
...
internal class FakeData
{
	...
	//public static Core.Domain.Ordering.Customer[] Customers { get; private set; } = System.Array.Empty<Core.Domain.Ordering.Customer>();
